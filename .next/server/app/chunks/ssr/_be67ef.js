(self.TURBOPACK = self.TURBOPACK || []).push(["chunks/ssr/_be67ef.js", {
...
async function runOperation(renderData) {
    ...
    const renderOpt = {
        ...
        buildManifest: {
            polyfillFiles: [],
            rootMainFiles: Object.values(layoutInfoChunks).flat().concat(__TURBOPACK__imported__module__$5b$project$2d$with$2d$next$5d2f$app$2f$page$2e$tsx$2f$next$2d$app$2d$hydrate$2e$tsx$2f$client$2d$transition$2e$js__["default"]).filter((path)=>path.endsWith(".js")),
            devFiles: [],
            ampDevFiles: [],
            lowPriorityFiles: [],
            pages: {
...
"[project-with-next]/app/page.tsx/next-app-hydrate.tsx/chunk_group_files.js (ssr)": (({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_cjs__, p: process, g: global, __dirname }) => (() => {

__turbopack_export_value__([
  "static/chunks/_c596a8.js",
...
//# sourceMappingURL=_be67ef.js.map