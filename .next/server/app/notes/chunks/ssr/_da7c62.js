(self.TURBOPACK = self.TURBOPACK || []).push(["chunks/ssr/_da7c62.js", {
...
async function runOperation(renderData) {
    ...
    const renderOpt = {
        ...
        buildManifest: {
            polyfillFiles: [],
            rootMainFiles: Object.values(layoutInfoChunks).flat().concat(__TURBOPACK__imported__module__$5b$project$2d$with$2d$next$5d2f$app$2f$notes$2f$page$2e$tsx$2f$next$2d$app$2d$hydrate$2e$tsx$2f$client$2d$transition$2e$js__["default"]).filter((path)=>path.endsWith(".js")),
            devFiles: [],
            ampDevFiles: [],
            lowPriorityFiles: [],
            pages: {
...
//# sourceMappingURL=_da7c62.js.map