...
var _indexCjs = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/nanoid/index.cjs (ecmascript, ssr)");
...
var _formatServerError = __turbopack_require__("[project-with-next]/node_modules/next/dist/lib/format-server-error.js (ecmascript, ssr)");
var _metadata = __turbopack_require__("[project-with-next]/node_modules/next/dist/lib/metadata/metadata.js (ecmascript, ssr)");
var _runWithRequestAsyncStorage = __turbopack_require__("[project-with-next]/node_modules/next/dist/server/run-with-request-async-storage.js (ecmascript, ssr)");
var _runWithStaticGenerationAsyncStorage = __turbopack_require__("[project-with-next]/node_modules/next/dist/server/run-with-static-generation-async-storage.js (ecmascript, ssr)");
...
async function renderToHTMLOrFlight(req, res, pathname, query, renderOpts) {
    ...
    const wrappedRender = async ()=>{
        ...
        const generateFlight = async ()=>{
            ...
            const flightData = [
                (await walkTreeWithFlightRouterState({
                    ...
                    isFirst: true,
                    rscPayloadHead: _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_metadata.Metadata, {
                        key: requestId,
        ...
        const ServerComponentsRenderer = createServerComponentRenderer(async ()=>{
            ...
            return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(AppRouter, {
                assetPrefix: assetPrefix,
                initialCanonicalUrl: initialCanonicalUrl,
                initialTree: initialTree,
                initialHead: _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_metadata.Metadata, {
                    key: requestId,
                    metadata: metadataItems
                }), initialHead),
...
var _appRouterHeaders = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/app-router-headers.js (ecmascript, ssr)");
var _appRender = __turbopack_require__("[project-with-next]/node_modules/next/dist/server/app-render.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/server/run-with-static-generation-async-storage.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_cjs__, p: process, g: global, __dirname, m: module, e: exports }) { !function() {
